...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/Page_OrangeHRM/i_Add Employee_oxd-icon bi-plus'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_OrangeHRM/Page_OrangeHRM/span_File type not allowed'), 'File type not allowed')
